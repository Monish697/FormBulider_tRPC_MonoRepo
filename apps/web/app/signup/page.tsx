...
export default function SignupPage() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#f6f4f1] text-slate-900 dark:text-white dark:bg-black dark:text-white flex items-center justify-center p-6 font-sans">
            ...
            <div className="relative z-10 w-full max-w-[420px]">
                <div className="text-center mb-10">
                    ...
                    <p className="mt-3 text-[15px] text-slate-600 dark:text-gray-300">
                        Start building calm, conversion-ready forms.
                    </p>
                </div>
                ...
                <div className="rounded-[32px] border border-black/10 dark:border-[#6FC3DF] bg-white/80 dark:bg-black p-8 shadow-2xl shadow-black/5 backdrop-blur-xl">
                    <form onSubmit={handleSubmit} className="space-y-4.5">
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-gray-300 pl-1 mt-4">
                                Work email
                            </label>
                            <input
                                type="email"
                    ...
                    <div className="mt-8 text-center text-sm text-slate-500 dark:text-gray-300">
                        ...
                        <Link href="/login" className="font-semibold text-slate-900 dark:text-white transition hover:text-slate-700 dark:text-gray-200">
                            Log in
                        </Link>
                    </div>
                </div>
